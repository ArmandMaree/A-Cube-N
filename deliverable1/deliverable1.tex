...
\begin{document}	
	...
	\section{Architecture Requirements}
		\subsection{Access Channel Requirements}
            ...
            \subsubsection{System Access Channels}
            	\paragraph\indent
                RESTful web services will as the system access channel for its lightweight, maintainability, and scalability. It will use URI's to allow easy access from the client side web service to server side. 
	...
	\section{Architecture Design}	
		...
		\subsection{Services}
			...
			\paragraph\indent
			Figure \ref{PollingServiceModelFigure} shows the class diagram of the pollers. A specific poller will use long polling to request new data from a specific PIM. Once it receives this information it will parse this information into a RawData object and add it into a queue which will be further processed by worker threads (see section  \ref{DataProcessingServiceSection}).			
			...
			\subsubsection{Business Logic Service}
