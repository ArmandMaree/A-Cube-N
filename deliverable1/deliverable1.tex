...
\begin{document}	
	...
	\section{Functional Requirements}		
		...
		\subsection{Domain Model}
			...
			\end{figure}
			\paragraph \indent
			The mind map for a user will portray information from PIMs requested by the user. The mind map will consist of a root node containing child nodes of relevant information (topics). Each topic will point to a source (Facebook, Google etc.) and will contain a map of information relative to the topic.
