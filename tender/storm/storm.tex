...
\begin{document}	
	...
	\section{The Team}
		...
		\subsection{Arno Grobler}
			...
			\paragraph{Motivation}
			The "rocking the boat" part of the 301 project had some flaws that I am sure every student said they knew why it wasn't working optimally and how it could be improved. This will then give me and my team an opportunity to actually realise those ideas.
		...
		\subsection{Armand Maree}
			...
			\paragraph{Motivation}
			Project STORM is particularly interesting since we are currently COS 301 students. This would allow us to directly assist in making the processes that the university uses more intelligent and more automated. Since the world is moving in the direction of automation and AI, it would be great to develop a system that does exactly that.
