	...
	\section{Project Execution}
		...
		\subsection{Initial Ideas}
			...
			\subsection{Potential Technologies}
				\paragraph\indent
				    		\begin{itemize}
	    		        \item   Git and GitHub: A distributive version control system that is easy to use and is free. It will be used to store and control the code written for the project and thus all code written by group memebers will be easily managed. (http://github.com/). 
