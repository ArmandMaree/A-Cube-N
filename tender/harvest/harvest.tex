	...
	\section{Project Execution}
		...
		\subsection{Deliverables}
		    ...
		    \begin{itemize}
		        ...
		        \item detailed documentation of the system - to facilitate any additions to the system
		        \item a user manual that provides detailed instructions on how to use the system in order to make use of the system in the most efficient and effective way 
