...
\begin{document}	
	...
	\section{Important Terminology}
		\begin{itemize}
			...
			\item \textbf{Data Source} This term will be used interchangeable with PIM. It refers to the source where user data is retrieved from.
			\item \textbf{Poller} The service which will constantly ask PIMs for new information and then send new informaton to the processing service.
		\end{itemize}	
	...
	\section{Architecture Requirements}
		\subsection{Access Channel Requirements}
            ...
            \subsubsection{System Access Channels}
            	\paragraph\indent
                Websocket based web services will be used as the system access channel. This is due to the bi-directional communication that it offers.
