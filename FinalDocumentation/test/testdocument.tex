...
\begin{document}	
	...
	\section{Introduction} 
		...
		\begin{itemize}
			\item The system is currently only able to cater for English items (like emails and posts), thus only this will be tested.
			\item All third party services (like MongoDB and RabbitMQ) are assumed to be functioning correctly and no tests will check for this.
			\item The pollers are not tested during the unit tests due to the need for them to receive authentication codes as it is outlined in the OAUTH2 protocol. In order to obtain these authentication codes a manual sign in has to occur by a user. Large parts of these services will thus be tested during the integration tests.
		\end{itemize} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	\section{Test Results}
		...
		\subsection{Frontend Service Test Cases}
			...
			%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
			\paragraph\indent
			All the tests for this service can be found on Github at \sloppy\url{https://github.com/ArmandMaree/MindMapPIM/tree/master/Frontend/src/test/javascript/loginTester.js}.
			
			\subsubsection{Frontend Login Dalekjs Test (TC \ref{frontendlogindalekjstest})}
				\paragraph{Result} Pass
				\paragraph{Comment} All conditions tested in this test case executed successfully.
	...
	\section{Conclusion}
		\paragraph\indent
		Apart from the unimplemented unit tests all unit tests and integration tests passed which is an indication that the application is fairly stable and of high quality. Due to the thorough nature of the tests that were conducted, the reliability, stability and integrety of the system is increased significantly.
