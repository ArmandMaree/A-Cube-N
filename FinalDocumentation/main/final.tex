...
\begin{document}	
	...
	\section{Important Terminology}
		\begin{itemize}
			...
			\item \textbf{data source} Personal Information Manager such as Google Calendar and social media platforms like Facebook.
			\item \textbf{Data Source} It refers to the source (third party data source) where user data is retrieved from.
	...
	\section{Architecture Requirements}
		...
		\subsection{Quality Requirements}
            ...
            \subsubsection{Flexibility}
            	\paragraph\indent
                The system must be flexible in terms of the plugablity of polling services. A new polling service for a new data source should be able to integrate with no change of the rest to the system. The system also should be able to function with any combination of data sources that a user selects.
		...
		\subsection{Integration Requirements}
			\begin{enumerate}
		        ...
		        \item \textbf{API:}\\
		            Since the system will gather its information through the consented use of the users social media, a vital part of the system is to use the already well developed infrastructure created by data sources and access the information through APIs.  
	    		\end{enumerate}
	...
	\section{Functional Requirements}		
		...
		\subsection{Use Case/Service Contracts}
    		...
    		\subsubsection{Change data sources}
				\textbf{Description:}  A user is may add or remove datasources as they want, however they must maintain either a Gmail or Facebook account on Unclutter in order to log in.\\
    			\textbf{Prioritisation:} Critical\\
      			\textbf{Pre-conditions}
    			\begin{itemize}
		...
		\end{figure}
		\paragraph\indent
		The mind map for a user will portray information from data sources requested by the user. The mind map will consist of a root node containing child nodes of relevant information (topics). Each topic will point to a data source (Facebook, Google etc.) and will contain a list of information relative to the topic.
