...
\begin{document}
    ...
    \section{Installation}
        ...
        \newpage
            ...
            \end{enumerate}
            \begin{center}
             \makebox[\textwidth]{\includegraphics[width=\textwidth]{chromepop.png}}
           \end{center}
        ...
        \newpage
            ...
            \end{enumerate}
           \begin{center}
              \makebox[\textwidth]{\includegraphics[width=\textwidth]{firefoxpop.png}}
            \end{center}
        ...
        \subsection{Internet Explorer}
            ...
            \end{enumerate}
            \begin{center}
              \makebox[\textwidth]{\includegraphics[width=\textwidth]{explopop.png}}
            \end{center}
        \newpage
        \subsection{Safari}
        \subsubsection{Enabling Cookies and Javascript}
         ...
         \subsubsection{Enabling Pop-ups}
            ...
            \end{enumerate}
            \begin{center}
              \makebox[\textwidth]{\includegraphics[width=\textwidth]{safaripop.png}}
            \end{center}
        \subsection{Security}
